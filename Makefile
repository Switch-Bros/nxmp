...
CFLAGS	:=	-g -ggdb -Wall -Wno-sign-compare -O2 -ffunction-sections -DCXXOPTS_NO_RTTI\
			$(ARCH) $(DEFINES) \
                $(GITREV)
CFLAGS  +=  -I${PORTLIBS}/include/upnp/ -I${PORTLIBS}/include/freetype2/
...
LIBS	:=  -lmpv `curl-config --libs` -ldvdnav -ldvdread  `aarch64-none-elf-pkg-config --libs libavformat libavcodec libavutil libavfilter libswscale libpostproc` -llzma -lopus -lvpx -lass -lharfbuzz -lfreetype -lfribidi -lmupdf -lmupdf-third -lfreetype  -lstdc++ -ldav1d -lpng -lbz2 -ltinyxml2 -lturbojpeg -llua5.1 -lssh2 -lmbedcrypto -lmbedx509 -lmbedtls -lmbedcrypto -lmbedx509 -lmbedtls -lsqlite3 -lsmb2  -lnfs -ljansson -lusbhsfs -lntfs-3g -llwext4 -lgme -lopenmpt -lbluray -laacs -ldeko3d -luam -larchive -lplacebo -lexpat -llzma -lzstd -llz4 -lbz2 -lz -lnx -lc -lz
