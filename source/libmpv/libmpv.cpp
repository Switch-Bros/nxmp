...
int64_t libMpv::getVideoBitrate(){
	double vbitrate;
...
void libMpv::setDeinterlace(int value){
	if(value == 1){
		mpv_command_string(handle,"vf remove @weavehwdeint");
		mpv_command_string(handle,"vf remove @bobhwdeint");
		mpv_command_string(handle,"vf add @bobhwdeint:lavfi=[deinterlace_nvtegra=mode=bob]");
	}else if(value == 2){
		mpv_command_string(handle,"vf remove @weavehwdeint");
		mpv_command_string(handle,"vf remove @bobhwdeint");
		mpv_command_string(handle,"vf add @weavehwdeint:lavfi=[deinterlace_nvtegra=mode=weave]");
